...
Route::prefix('admin')->middleware(['auth', 'can:is-admin'])->group(function () {
    ...
    Route::patch('categories/{category}/toggle', [CategoryController::class, 'toggleActive'])->name('admin.categories.toggle');
    Route::resource('pickup_points', PickupPointController::class);
});
