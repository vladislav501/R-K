...
<body>
    <div class="invoice">
        ...
        <p>Способ получения: <strong>{{ $preOrder->receivingMethod }}</strong></p>
        <p>Адрес: <strong>{{ $preOrder->deliveryAddress }}</strong></p>
        ...
        <p class="invoiceText">При получении товара в пункте выдачи, предъявите чек менеджеру пункта выдачи.</p>
        <p class="invoiceText">При получении товара от курьера, предъявите чек курьеру для проверки оплаты товара.</p>
    </div>
</body>
</html>